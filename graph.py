...
if (len(sys.argv)>2):
    ...
    MAINDIR=sys.argv[2]       # Where the images are located
else:
...
def graphMobility():
    ...
    # UE / gNb images
    gNbicon=plt.imread(get_sample_data(f'{MAINDIR}/images/gNb.png'))
    gnbBox = OffsetImage(gNbicon, zoom = 0.25)

    UEicon=plt.imread(get_sample_data(f'{MAINDIR}/images/UE.png'))
    ...
    for bld in buildingList:
        ...
        if phyData["istree"]:
            bldIcon = plt.imread(get_sample_data(f'{MAINDIR}/images/tree.png'))
